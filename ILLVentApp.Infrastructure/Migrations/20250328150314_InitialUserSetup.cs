        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrCode = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false, defaultValueSql: "NEWID()"),
                    Address = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, defaultValue: "Pending"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImmunizationHistories", x => x.ImmunizationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasHighBloodPressure = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HasLowBloodPressure = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HasDiabetes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DiabetesType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Conditions = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SurgeryHistory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Allergies = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BirthControlMethod = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BloodTransfusionObjection = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AspirinUsage = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PacksPerDay = table.Column<float>(type: "real", nullable: false),
                    YearsSmoked = table.Column<int>(type: "int", nullable: false),
                    YearStopped = table.Column<int>(type: "int", nullable: false),
                    AlcoholDrinksPerDay = table.Column<int>(type: "int", nullable: false),
                    AlcoholDrinksPerWeek = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AmbulanceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AmbulancePlateNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "EmergencyRescueRequests",
                columns: table => new
                {
                    RequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AcceptedHospitalId = table.Column<int>(type: "int", nullable: true),
                    RequestDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequestImage = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    RequestStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    InjuryDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    InjuryPhotoUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmergencyRescueRequests", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_EmergencyRescueRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmergencyRescueRequests_Hospitals_AcceptedHospitalId",
                        column: x => x.AcceptedHospitalId,
                        principalTable: "Hospitals",
                        principalColumn: "HospitalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DealDetails = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deals_Pharmacies_PharmacyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRescueRequests_AcceptedHospitalId",
                table: "EmergencyRescueRequests",
                column: "AcceptedHospitalId");

            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRescueRequests_UserId",
                table: "EmergencyRescueRequests",
                column: "UserId");
