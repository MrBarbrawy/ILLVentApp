        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptInsurance = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    StartTime = table.Column<TimeSpan>(type: "time", nullable: false, defaultValue: new TimeSpan(9, 0, 0)),
                    EndTime = table.Column<TimeSpan>(type: "time", nullable: false, defaultValue: new TimeSpan(17, 0, 0)),
                    SlotDurationMinutes = table.Column<int>(type: "int", nullable: false, defaultValue: 30),
                    WorkingDays = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "1,2,3,4,5")
                },
                constraints: table =>
                {
