...
namespace ILLVentApp.Infrastructure.Migrations
{
    ...
    [Migration("20250609183043_Add_URLAttributeForHospitals&Pharmacies")]
    partial class Add_URLAttributeForHospitalsPharmacies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.Appointment", b =>
                {
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.CartItem", b =>
                {
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.EmergencyRescueRequest", b =>
                {
                    ...
                    b.Property<DateTime?>("HospitalResponseTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("MedicalHistorySource")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("NotifiedHospitalIds")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RejectedByHospitalIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HasMedicalDataStorage")
                        .HasColumnType("bit");

                    b.Property<bool>("HasNFC")
                        .HasColumnType("bit");

                    b.Property<bool>("HasRescueProtocol")
                        .HasColumnType("bit");

                    b.Property<bool>("HasVitalSensors")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.Schedule", b =>
                {
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.TimeSlot", b =>
                {
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.Appointment", b =>
                {
                    b.HasOne("ILLVentApp.Domain.Models.Doctor", "Doctor")
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.CartItem", b =>
                {
                    b.HasOne("ILLVentApp.Domain.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.OrderItem", b =>
                {
                    b.HasOne("ILLVentApp.Domain.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("ILLVentApp.Domain.Models.TimeSlot", b =>
                {
                    b.HasOne("ILLVentApp.Domain.Models.Appointment", "Appointment")
                        .WithMany()
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ILLVentApp.Domain.Models.Schedule", "Schedule")
                        .WithMany("TimeSlots")
